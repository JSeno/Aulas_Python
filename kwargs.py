...
Este é só mais um parâmetro, mas diferente do *args que coloca os valores extras em uma tupla o **kwargs exige que utilizemos
...
#     return 'Não tenho certeza de quem você seja'
...
# def minha_info(a, b, *args, instrutor='Geek', **kwargs):
#     return [a, b, args, instrutor, kwargs]

# print(minha_info(1, 2, 3, sobrenome='University', cargo='Instrutor'))
# Retorno correto [1, 2, (3), 'Geek', {'sobrenome': 'University', 'cargo': 'Instrutor'}]

# Função com a ordem incorreta de parâmetros
# def minha_info(a, b, instrutor='Geek', *args, **kwargs):
#     return [a, b, args, instrutor, kwargs]

# print(minha_info(1, 2, 3, sobrenome='University', cargo='Instrutor'))
# Retorno incorreto [1, 2, (), 3, {'sobrenome': 'University', 'cargo': 'Instrutor'}]
